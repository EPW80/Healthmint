 ...
 * FocusTrap Component
 *
 * A utility component that traps focus within its children when active
 * Improves accessibility of modals and popups by preventing users from
 * tabbing outside the contained elements
 */
const FocusTrap = ({
  children,
  active = true,
