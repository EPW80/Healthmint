  ...
  const connectWallet = async () => {
    try {
      ...
      if (network.chainId !== requiredChainId) {
        setErrorMessage(
          `Please switch to ${contractInfo.marketplace.network} network`
        );
        return;
      }
      ...
      {contract && (
        <>
          ...
          >
            ...
            <p>
              <strong>Your Role/Status:</strong>{" "}
              {userRole !== null ? userRole : "Loading..."}
            </p>
            <div>
          ...
          >
            ...
            <p>
              This will attempt to create a test data listing in the
              marketplace.
            </p>
            <button
