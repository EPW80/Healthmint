  ...
  const connectWallet = async () => {
    try {
      ...
      if (network.chainId !== requiredChainId) {
        setErrorMessage(
          `Wrong network. Please switch to ${contractInfo.marketplace.network} (ChainId: ${requiredChainId})`
        );
        ...
        try {
          ...
          if (switchError.code === 4902) {
            setErrorMessage(
              `Please add the ${contractInfo.marketplace.network} network to MetaMask`
            );
          }
        }
      }
    ...
    <div style={{ maxWidth: "700px", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <button
          ...
          style={{
            ...
            fontSize: "16px",
            backgroundColor:
              connectionStatus === "Connected" ? "#4CAF50" : "#2196F3",
            color: "white",
            border: "none",
            borderRadius: "4px",
            cursor: "pointer",
      ...
      {account && (
        ...
        >
          ...
          <p>
            <strong>Expected Chain ID:</strong>{" "}
            {contractInfo.marketplace.chainId} (Sepolia)
          </p>
        </div>
      )}
      ...
      {contractAddress && (
        ...
        >
          ...
          <p>
            ...
            {new Date(contractInfo.deploymentDate).toLocaleString()}
          </p>
        </div>
      )}
    </div>
