...
class MockDataService {
    ...
    this.mockDatasets = [
      {
        ...
        description:
          "Anonymized records of 1000+ diabetes patients including treatment outcomes and metrics",
      ...
      },
      {
        ...
        description:
          "High-resolution cardiac MRI images with professional annotations",
        category: "Cardiology",
        price: "0.25",
        recordCount: 532,
        format: "DICOM",
      ...
      },
      {
        ...
        description:
          "Comprehensive survey results from 5000+ participants on anxiety and depression",
        category: "Psychology",
        price: "0.10",
        recordCount: 5329,
        format: "JSON",
      ...
      "dataset-001": [
        {
          ...
          recordCount: 300,
          price: "0.05",
          description: "Basic sample of the dataset",
        },
        {
          id: "standard",
          name: "Standard",
          ...
          recordCount: 600,
          price: "0.10",
          description: "Half of the complete dataset",
        },
        {
          id: "complete",
          name: "Complete",
          ...
          recordCount: 1247,
          price: "0.15",
          description: "Full access to all records",
        },
      ],
      "dataset-002": [
        {
          ...
          recordCount: 133,
          price: "0.08",
          description: "Sample of MRI images",
        },
        {
          id: "standard",
          name: "Standard",
          ...
          recordCount: 266,
          price: "0.15",
          description: "Half of the MRI dataset",
        },
        {
          id: "complete",
          name: "Complete",
          ...
          recordCount: 532,
          price: "0.25",
          description: "Complete image collection",
        },
      ],
      "dataset-003": [
        {
          ...
          recordCount: 1330,
          price: "0.03",
          description: "Survey data sample",
        },
        {
          id: "standard",
          name: "Standard",
          ...
          recordCount: 2665,
          price: "0.06",
          description: "50% of survey results",
        },
        {
          id: "complete",
          name: "Complete",
          ...
          recordCount: 5329,
          price: "0.10",
          description: "Full survey dataset",
        },
      ],
    };
  ...
  async downloadDataset(datasetId, isSubset = false) {
    ...
    console.log(
      `Mock downloading ${isSubset ? "subset" : "dataset"}: ${datasetId}`
    );
  ...
  async saveSubset(parentDatasetId, subsetData) {
    ...
    const newSubset = {
      ...
      recordCount:
        subsetData.recordCount || Math.floor(Math.random() * 1000) + 100,
